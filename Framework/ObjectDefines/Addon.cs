...
namespace Framework.ObjectDefines
{
    public class Addon
    {
        ...
        public uint UrlStringCRC { get; set; }      // This one is sent in case of Url string not null
        ...
        public byte Version { get; set; }           // Version to highlight button on new addons (4 bytes, used only 1)
    }
}
